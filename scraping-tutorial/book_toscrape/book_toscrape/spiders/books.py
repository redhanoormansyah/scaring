...
class BooksSpider(Spider):
    ...
    # get hasil untuk mengfilter gunakan fungsi init dan masukan parameter url seperti dicontohkan dibawah
    # isi fungsi seperti dibawah
    def __init__(self, category):
        self.start_urls = [category]
    # menjalankan hasil category diterminal => scapy crawl nama_spider -a "tempelkan_nama_parameter"
